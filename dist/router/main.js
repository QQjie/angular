...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.clickToBaidu = function () {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router1, http1) {
    ...
    LoginComponent.prototype.onClickMe = function () {
        var username = jquery__WEBPACK_IMPORTED_MODULE_3__("#username").val().toString();
        var password = jquery__WEBPACK_IMPORTED_MODULE_3__("#inputPassword").val().toString();
    ...
    LoginComponent.prototype.onClickMe1 = function () {
        this.router.navigate(['/index']);
    };
...
module.exports = __webpack_require__(/*! G:\angularworkspaces\luyou\router\src\main.ts */"./src/main.ts");
